...
const GenderGrid = () => {
  ...
  return (
    <section
      className="relative w-full px-4 sm:px-6 md:px-8 lg:px-12 py-12 md:py-16 bg-premium-beige overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 text-center mb-8 md:mb-12">
        ...
        <p className="text-text-medium text-sm md:text-base lg:text-lg max-w-2xl mx-auto">
                ...
                <div className="relative h-[150px] overflow-hidden bg-premium-cream">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-2">
                    <div className="flex flex-col items-start">
                      <div className="text-sm font-bold text-white uppercase mb-1 text-left">
                        {category.title}
                      </div>
                      <div className="text-white/90 text-xs tracking-wide mb-2 text-left">
                        {category.description}
                      </div>
                      <div className="text-luxury-gold text-[10px] uppercase group-hover:text-white transition-colors duration-300 text-left">
            ...
            >
              ...
              <div className="relative h-[250px] overflow-hidden bg-premium-cream">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <div className="flex flex-col items-start">
                    <div className="text-2xl font-bold text-white uppercase  mb-2 group-hover:scale-105 transition-transform duration-300 text-left">
                      Women
                    </div>
              ...
              >
                ...
                <div className="relative h-[500px] overflow-hidden bg-premium-cream">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    <div className="flex flex-col items-start">
                      <div className="text-4xl font-bold text-white uppercase  mb-3 group-hover:scale-105 transition-transform duration-300 text-left">
                        Women
                      </div>
                      <div className="text-white/90 text-lg tracking-wide mb-3 text-left">
                        The art of elegance and grace
                      </div>
                      <div className="text-luxury-gold text-sm uppercase  group-hover:text-white transition-colors duration-300 text-left">
                        Step into elegance →
                      </div>
                    </div>
                  </div>
      ...
      <div className="text-center mt-12 md:mt-16">
        {/* <button className="px-8 py-4 bg-gradient-to-r from-black to-text-dark text-white font-semibold text-lg uppercase  hover:bg-luxury-gold hover:text-white transition-all duration-500 transform hover:scale-105 border-2 border-black hover:border-luxury-gold shadow-lg hover:shadow-2xl">
